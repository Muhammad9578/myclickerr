...
class PhotographerActiveBookingsScreen extends StatefulWidget {
  const PhotographerActiveBookingsScreen({Key? key}) : super(key: key);

  @override
  State<PhotographerActiveBookingsScreen> createState() =>
      _PhotographerActiveBookingsScreenState();
}

class _PhotographerActiveBookingsScreenState
    extends State<PhotographerActiveBookingsScreen> {
          ...
          Expanded(
            ...
            child: SmartRefresher(
              controller: photographerBookingListProvider
                  .pActiveBookingRefreshController,
              onRefresh: () {
              ...
              child: Consumer<PhotographerBookingListController>(
                ...
                if (bookingListPrvdr.activeBooking == null) {
                  return Center(child: Text("Loading"));
                }
                productList.clear();
                productList.addAll(
                  bookingListPrvdr.activeBooking!.where((element) {
                    try {
                ...
                if (productList.isEmpty) {
                  return Center(
                    child: Text('There is no active booking'),
                  );
                }
