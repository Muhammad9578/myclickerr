...
class PhotographerAllBookingScreen extends StatefulWidget {
  static const String route = "photographerAllBookingScreen";

  const PhotographerAllBookingScreen({Key? key}) : super(key: key);

  @override
  State<PhotographerAllBookingScreen> createState() =>
      _PhotographerAllBookingScreenState();
}

class _PhotographerAllBookingScreenState
    extends State<PhotographerAllBookingScreen> {
            ...
            Expanded(
              ...
              child: SmartRefresher(
                ...
                child: Consumer<PhotographerBookingListController>(
                  ...
                  productList.clear();
                  productList.addAll(
                    bookingListPrvdr.allBookings!.where((element) {
                      try {
